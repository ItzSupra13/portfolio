					...
					<div className="space-y-8">
						...
						<div className="relative pl-10">
							...
							<p className="max-w-xl text-sm leading-relaxed text-zinc-400">
								Co-Directed a{' '}
								<span className="text-zinc-200">5+ minute AI screenplay</span>{' '}
								for the Global AI Film Awards. Orchestrated the full production
								pipeline from
								<span className="text-zinc-200">
									{' '}
									character consistency
								</span>{' '}
								and landscape architecture to sound design. Leveraged{' '}
								<span className="text-zinc-200">Google Veo</span> with advanced
								anti-vision prompting to ensure professional-grade cinematic
								fidelity and temporal stability for my Client.
							</p>
						</div>
